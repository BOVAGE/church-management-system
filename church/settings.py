...
MIDDLEWARE = [
    # 'whitenoise.middleware.WhiteNoiseMiddleware', no longer using whitenoise
...
# STATICFILES_STORAGE = 'whitenoise.storage.CompressedManifestStaticFilesStorage' no longer using whitenoise
